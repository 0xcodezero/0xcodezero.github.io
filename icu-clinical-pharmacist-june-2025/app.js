...
const CASES = [
  ...
  'patient_1100426_2023-11-05.html',
  'patient_1089371_2023-11-09.html',
  'patient_1100426_2023-11-09.html',
  'patient_322762_2023-11-09.html',
  'patient_1100426_2023-11-12.html',
  ...
  'patient_1081457_2023-12-10.html',
  ...
  'patient_1111120_2024-02-08.html',
  ...
  'patient_1115499_2024-04-15.html',
    ...
    interventions.forEach((intervention) => {
      ...
      button.onclick = () => {
        ...
        if (
          ...
          content.innerHTML = `<iframe class="case-iframe" src="cases-icu-doctors-notes/${intervention.filename}"></iframe>`;
        }
      };
